 ...
 <div class="panel-heading">Laravel 5.5 - import export data into excel and csv using maatwebsite </div>
  ...
  <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <a href="{{ route('export.file',['type'=>'jpg']) }}">Download jpg</a> |

        <a href="{{ route('export.file',['type'=>'jpeg']) }}">Download jpeg</a> |

        <a href="{{ route('export.file',['type'=>'png']) }}">Download png</a> |

        <a href="{{ route('export.file',['type'=>'pdf']) }}">Download pdf</a>
